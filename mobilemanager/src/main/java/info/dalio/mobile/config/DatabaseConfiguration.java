...
import info.dalio.mobile.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("info.dalio.mobile.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("info.dalio.mobile.repository.search")
